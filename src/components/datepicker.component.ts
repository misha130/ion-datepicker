...
@Component({
    template: `<div class="datepicker-modal-container">
	<div class="datepicker-modal" [style.width]="full?'100%':''" [style.height]="full?'100%':''">
		...
		<div class="datepicker-calendar" *ngIf="showType('calendar')">
			<div class="row col center">
				<button small ion-button clear (click)="prevMonth()"><ion-icon name="arrow-back"></ion-icon></button>{{getTempMonth()}} {{getTempYear()}}
